...
namespace CoreAutomation.AspNet.Commands.ExplorerCommands.SourceCode
{
    ...
    /// </summary>
    public class AddMembersCDFCommand : CSharpSourceCommandBase
    {
        private static readonly string commandTitle = "Add Missing Members";
        private static readonly string commandDescription = "Adds missing interface members from the target class. That also integrate CommonDeliveryFramework functionality.";

#pragma warning disable CS1998

        /// <inheritdoc />
        public AddMembersCDFCommand(ILogger logger, IVsActions vsActions) : base(logger, vsActions, commandTitle, commandDescription)
        {
            //Intentionally blank
        }
