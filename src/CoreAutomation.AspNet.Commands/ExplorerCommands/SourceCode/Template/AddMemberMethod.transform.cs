...
{
    public partial class AddMemberMethod : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new AddMemberMethod { CsModels = null, ModelData = null };
        ...
        {
            var factory = new AddMemberMethod { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new AddMemberMethod { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new AddMemberMethod { CsModels = null, ModelData = modelData };
